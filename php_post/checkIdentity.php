<?php
    ...
    if(isset($_POST['me_id'])) {
		...
		if(mysqli_num_rows($result_habitat)>0){
			...
			while ($row_habitat = mysqli_fetch_assoc($result_habitat)) {
				if($row_habitat["yes_no"]=="yes"){
					var emoteToggle = '<button id="emoteToggle">Show emote window</button>';
					if($row_habitat["habitat"]=="spaceship"){
						echo '<img src="assets_and_scenes/singular_spaceship_time.gif" alt="spaceship with flaming exhaust"><div id="robots"></div>' . emoteToggle;
					}
					else if($row_habitat["habitat"]=="backyard"){
						echo '<img src="assets_and_scenes/singular_backyard.gif" alt="green grassy backyard"><div id="robots"></div>' . emoteToggle;
					}
					else if($row_habitat["habitat"]=="city"){
						echo '<img src="assets_and_scenes/singularitrons_roadway3.png" alt="busy city with window lights"><div id="robots"></div>' . emoteToggle;
					}
					else if($row_habitat["habitat"]=="lab"){
						echo '<img src="assets_and_scenes/singularitrons_mad_science.gif" alt="green grassy backyard"><div id="robots"></div>' . emoteToggle;
					}
				}
			}
		}
