		...
		$("#submitSentence").click(function(){
			...
			$("#next_starter").click(function(){
                ...
                if($("#starter_item img").attr("class")=="pseudo"){
                       $("#starter_item img").attr("alt", "Connectotalx robot")
					   $("#starter_item img").attr("class","connect")
					   $("#starter_item img").attr("src", "assets_and_scenes/connectPack.png").fadeIn();
						   $("#welcome").html('<p>Connectotalx is a three-eyed wrench-bearing robot.</p>');
                }
                else if($("#starter_item img").attr("class")=="connect"){
                       $("#starter_item img").attr("alt", "Molly bot")
					   $("#starter_item img").attr("class", "molly")
					   $("#starter_item img").attr("src", "assets_and_scenes/mollyPack.png").fadeIn();
					$("#welcome").html("<p>Mollybot may look like a clown, but she'll surprise you!</p>");
                }
                else if($("#starter_item img").attr("class")=="molly"){
                       $("#starter_item img").attr("alt", "Clever Fred robot")
					   $("#starter_item img").attr("class", "fred")
					   $("#starter_item img").attr("src", "assets_and_scenes/fredPack.png").fadeIn();
					$("#welcome").html('<p>Clever Fred thinks he\'s so smart...</p>');
                }
                else {
                    $("#starter_item img").attr("alt", "pseudobot")
					$("#starter_item img").attr("class", "pseudo")
					$("#starter_item img").attr("src", "assets_and_scenes/pseudobotPack.png").fadeIn();
